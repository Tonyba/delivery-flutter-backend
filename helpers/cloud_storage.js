...
const env = require('../helpers/storage_env')
...
const storage = new Storage({
    projectId: "delivery-app-a7991",
    keyFilename: './serviceAccountKey.json'
});

const bucket = storage.bucket("gs://delivery-app-a7991.appspot.com");
    ...
    return new Promise((resolve, reject) => {
        ...
        if (deletePathImage) {
            ...
            if (deletePathImage != null || deletePathImage != undefined) {
                const uri = deletePathImage;
                const deleteUrl = new URL(uri);

                const parseDeletePathImage = deleteUrl;
